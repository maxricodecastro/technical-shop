...
│    "professional" → blazers      (NO color mappings - data-driven)│
└───────────────────────────┬─────────────────────────────────────┘
...
│    LLM generates: subcategory, material, style chips ONLY       │
└───────────────────────────┬─────────────────────────────────────┘
...
│    ✓ "sweaters" exists in subcats  (color chips removed here)   │
└───────────────────────────┬─────────────────────────────────────┘
                            │ After validation...
                            ▼
┌─────────────────────────────────────────────────────────────────┐
│                  LAYER 4: Data-Driven Facets                     │
│                  (Colors derived from catalog)                   │
│                                                                  │
│    Query: "What colors exist for sweaters + hoodies?"           │
│    Result: brown, gray, navy, cream (actual catalog data)       │
│    Also supplements materials with what's actually available    │
└─────────────────────────────────────────────────────────────────┘
```
...
|---------|---------------|-----------|------------|--------|
| warm | sweaters, coats, hoodies, fleece-jackets | wool, cashmere, fleece, down | cozy, winter | — |
| cool / light | t-shirts, shorts, tank-tops, dresses | linen, cotton | lightweight, breathable | — |
| summer | dresses, shorts, tank-tops, swimwear | linen, cotton | casual, lightweight | bright colors |
| winter | coats, sweaters, boots | wool, down, fleece | cozy, layered | — |
| fall / autumn | sweaters, jackets, boots | wool, suede, denim | layered, cozy | earth tones |
| spring | blouses, light-jackets, dresses | cotton, linen | fresh, light | pastels |

### Formality / Occasion

| Concept | Subcategories | Materials | Style Tags |
|---------|---------------|-----------|------------|
| casual | t-shirts, jeans, hoodies, sneakers | cotton, denim | relaxed, everyday, comfortable |
| professional / work | blazers, dress-shirts, slacks, blouses | wool, cotton-blend | formal, business, classic |
| formal / dressy | suits, dresses, dress-shoes | silk, wool, satin | elegant, sophisticated |
| date night | dresses, blouses, nice-tops | silk, satin, velvet | elegant, fitted, romantic |
| workout / athletic | leggings, sports-bras, tank-tops, shorts | nylon, spandex, moisture-wicking | athletic, performance |
| loungewear / comfort | sweatpants, hoodies, pajamas | fleece, cotton, jersey | cozy, relaxed, soft |
...
| Concept | Subcategories | Materials | Style Tags | Colors |
|---------|---------------|-----------|------------|--------|
| minimalist | basics, simple-tops, clean-lines | cotton, linen | clean, simple, modern | neutrals |
| bohemian / boho | dresses, flowy-tops, skirts | linen, cotton, crochet | flowy, relaxed, artistic | earth tones |
| preppy | polos, chinos, blazers, sweaters | cotton, wool | classic, polished | navy, white, pastels |
| streetwear | hoodies, sneakers, joggers, graphic-tees | cotton, denim | urban, casual, oversized | — |
| vintage / retro | high-waisted, denim-jackets | denim, leather, corduroy | vintage, retro, classic | — |
| edgy / punk | leather-jackets, boots, black-jeans | leather, denim | edgy, bold | black |
| romantic | dresses, blouses, skirts | silk, lace, chiffon | feminine, delicate, flowy | pastels, florals |
| cozy | sweaters, hoodies, cardigans | fleece, wool, knit | comfortable, oversized, soft | — |
...
After validation, the system adds data-driven facets:

### Colors (Fully Data-Driven)
1. Extract subcategory values from LLM chips
2. Query catalog: "What colors exist for these subcategories?"
3. Create color chips for each unique color found
4. Colors are ranked by frequency (most common first)

### Materials (Supplemented)
1. Keep LLM-suggested materials that passed validation
2. Query catalog: "What other materials exist for these subcategories?"
3. Add any materials not already suggested by LLM

This ensures users only see options that will return actual products.
...
{
  "chips": [
    { "type": "subcategory", "filterValue": "sweaters" },     // ✓ valid
    { "type": "color", "filterValue": "mauve" },              // ✗ not in catalog
    { "type": "material", "filterValue": "cashmere" }         // ✓ valid
  ]
}
...
// "mauve" was dropped, but user still gets useful suggestions
```
